...
number1 = int(input("Please enter a number between 1-999"))
number2 = int(input("Please another number between 1 -999 less then first one "))
...
slice_of_words = words[number2 - 1:number1]

print(slice_of_words)
# Second question
...
for i in range (1,31):
    multiplication_of_numbers[i]= i * (i-1)
